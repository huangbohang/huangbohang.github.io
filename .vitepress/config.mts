...
export default defineConfig({
  ...
  description: "黄博航的博客,huangbohang's Blog,huangbohang,huangbohang,huangbohang,黄博航,徐涛涛,徐涛,blog,Blog,技术博客,博客,个人博客,技术总结,问题解析,个人成长,前端,JavaScript,Vue,React,网络,Electron,Node.js,TypeScript,Rust",
  themeConfig: {
    siteTitle:'黄博航的博客',
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/huangbohang' }
    ]
  }
})
